...
<head>
    ...
    <style>
        ...
        .styled-input {
            padding: 12px 16px; border-radius: 8px; border: 1px solid #444; font-size: 1.1em;
            background: #23243a; color: #f1f1f1; margin-bottom: 16px; width: 260px; box-sizing: border-box;
...
<footer style="text-align:center; margin-top:24px; color:#ccc;">
