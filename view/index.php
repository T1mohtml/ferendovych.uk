...
<head>
    ...
    <style>
        body { background: #1e1f26; margin: 0; font-family: 'Inter', sans-serif; color: #ffd700; }
        .centered-container { display: flex; flex-direction: column; align-items: center; padding: 32px 16px; }
        .card { background:#23243a; border-radius:18px; box-shadow:0 4px 24px rgba(60,60,100,0.18); padding:36px 32px; max-width:600px; width:100%; border:1.5px solid #3949ab; display:flex; flex-direction:column; align-items:center; }
