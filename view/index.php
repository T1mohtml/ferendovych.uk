...
<head>
    ...
    <style>
        ...
        .styled-list li {
            ...
            color:#ffd700; margin-bottom:10px; padding:12px 18px;
            border-radius:8px; font-size:1.1em; font-weight:500;
        ...
        button.big-button {
            ...
            color:#fff; border:none; border-radius:12px; padding:16px 28px;
            cursor:pointer; margin-top:12px; transition: transform 0.2s, background 0.3s;
        }
        ...
        .empty-message {
            ...
            background:linear-gradient(135deg,#23243a 80%,#3949ab 100%);
            color:#ffd700; font-weight:600; font-size:1.1em; text-align:center;
            box-shadow:0 2px 8px rgba(60,60,100,0.12); max-width:350px;
        }
    </style>
</head>
<body>
