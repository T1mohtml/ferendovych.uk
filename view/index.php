...
<head>
    ...
    <style>
        ...
        .card { background:#23243a; border-radius:18px; box-shadow:0 4px 24px rgba(60,60,100,0.18); padding:36px 32px; max-width:420px; width:100%; margin:32px auto; border:1.5px solid #3949ab; display:flex; flex-direction:column; align-items:center; }
        .styled-list { list-style:none; padding:0; margin:24px 0 18px; width:100%; }
        ...
        .empty-message { margin:18px 0; padding:10px 18px; border-radius:8px; background:linear-gradient(135deg,#23243a 80%,#3949ab 100%); color:#ffd700; font-weight:600; font-size:1.1em; text-align:center; box-shadow:0 2px 8px rgba(60,60,100,0.12); max-width:350px; }
    </style>
</head>
<body>
