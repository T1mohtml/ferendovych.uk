...
const styles = {
  ...
  guestbookButton: {
    ...
    marginTop: "2rem",
    marginBottom: "1rem",
    boxShadow: "0 8px 32px rgba(124, 58, 237, 0.55), 0 2px 8px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.18)",
    zIndex: 10,
  ...
  heading: {
    ...
    lineHeight: 1.05,
    background: "linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 35%, #a78bfa 65%, #c4b5fd 100%)",
  ...
  aboutHeading: {
    ...
    fontWeight: 800,
    letterSpacing: "-0.02em",
    background: "linear-gradient(135deg, #c4b5fd 0%, #818cf8 60%, #a5f3fc 100%)",
    WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent",
    backgroundClip: "text",
  },
  ...
  floatingElement1: {
    ...
    height: "420px",
    borderRadius: "50%",
    background: "radial-gradient(circle, rgba(124,58,237,0.22) 0%, rgba(79,70,229,0.1) 55%, transparent 100%)",
    filter: "blur(48px)",
    zIndex: 0,
    pointerEvents: "none",
  },
  floatingElement2: {
    ...
    height: "380px",
    borderRadius: "50%",
    background: "radial-gradient(circle, rgba(165,243,252,0.14) 0%, rgba(99,102,241,0.1) 55%, transparent 100%)",
    filter: "blur(48px)",
    zIndex: 0,
    pointerEvents: "none",
  },
  floatingElement3: {
    ...
    height: "280px",
    borderRadius: "50%",
    background: "radial-gradient(circle, rgba(236,72,153,0.1) 0%, rgba(124,58,237,0.07) 55%, transparent 100%)",
    filter: "blur(40px)",
    zIndex: 0,
    pointerEvents: "none",
  },
  ...
  imageWrapper: {
    ...
    padding: "4px",
    borderRadius: "50%",
    background: "linear-gradient(135deg, #7c3aed, #818cf8, #38bdf8, #a78bfa, #7c3aed)",
